        ...
        <div style={{
            ...
            <div>
                <div className='flex items-center'>
                    <img src={logo} />
                    <p className='text-center text-[#4879F5] text-[32px] font-[500]'>ICT PARK</p>
                </div>
                <div className='ml-[70px]'>
                    <p className='font-[300] text-[24px] text-[#A3A3A3]'><FontAwesomeIcon icon="envelope" />ictpark@gmail.com</p>
                    <p className='font-[300] text-[24px] text-[#A3A3A3]'><FontAwesomeIcon icon="phone" />+251999999</p>
                </div>
            </div>
            ...
            <div className='flex flex-col'>
                ...
                <p className='font-[300] text-[24px] text-[#4879F5]'><FontAwesomeIcon icon="location" /> GORO,ADDIS ABABA</p>
            </div>
