    ...
    <>
      <div className="bg-white w-64 text-blue-600 text-xl p-6 flex flex-col border-r-2 border-neutral-200 fixed h-screen z-20">
        ...
        <div className="my-10 flex-1">
          ...
          <Link to="/investor/request">
            <div
              className={
                pathname === "/investor/request"
                  ? "mb-4 bg-neutral-200"
                  : "mb-4 hover:bg-neutral-200"
              }
            >
          ...
          <Link to="/investor/myrequest">
            <div
              className={
                pathname === "/investor/myrequest"
                  ? "mb-4 bg-neutral-200"
                  : "mb-4 hover:bg-neutral-200"
              }
            >
          ...
          <Link to="/investor/completed">
            <div
              className={
                pathname === "/investor/completed"
                  ? "mb-4 bg-neutral-200"
                  : "mb-4 hover:bg-neutral-200"
              }
            >
          ...
          <Link to="/investor/decline">
            <div
              className={
                pathname === "/investor/decline"
                  ? "mb-4 bg-neutral-200"
                  : "mb-4 hover:bg-neutral-200"
              }
            >
